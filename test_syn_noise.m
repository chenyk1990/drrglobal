...
sigmas=[0.001:0.001:0.01]*50;
snrs1=zeros(length(sigmas),1);
snrs2=zeros(length(sigmas),1);
snrs3=zeros(length(sigmas),1);
...
flow=0;fhigh=125;dt=0.004;N=2;Niter=20;mode=1;verb=1;
...
set(gca,'Linewidth',2,'Fontsize',20); 
    print(gcf,'-depsc','-r400','syn_obs_noise2.eps');
    figure;yc_wigbh(D3,h0,t,1);ylim([-0.9,20]);
    ylabel('Distance (deg)','Fontsize',20);
xlabel('Time (s)','Fontsize',20);
set(gca,'Linewidth',2,'Fontsize',20); 
    print(gcf,'-depsc','-r400','syn_pocs_noise2.eps');
    figure;yc_wigbh(D5,h0,t,1);ylim([-0.9,20]);
    ylabel('Distance (deg)','Fontsize',20);
xlabel('Time (s)','Fontsize',20);
set(gca,'Linewidth',2,'Fontsize',20); 
...
annotation(gcf,'ellipse',...
    ...
    'LineWidth',2,...
    'LineStyle','--');
print(gcf,'-depsc','-r400','syn_ves_rr_noise2.eps')
end
...
xlabel('Time (s)','Fontsize',20);
set(gca,'Linewidth',2,'Fontsize',20); 
    print(gcf,'-depsc','-r400','syn_obs_noise4.eps');
    figure;yc_wigbh(D3,h0,t,1);ylim([-0.9,20]);
    ylabel('Distance (deg)','Fontsize',20);
xlabel('Time (s)','Fontsize',20);
set(gca,'Linewidth',2,'Fontsize',20); 
    print(gcf,'-depsc','-r400','syn_pocs_noise4.eps');
    figure;yc_wigbh(D5,h0,t,1);ylim([-0.9,20]);
    ylabel('Distance (deg)','Fontsize',20);
xlabel('Time (s)','Fontsize',20);
set(gca,'Linewidth',2,'Fontsize',20); 
...
annotation(gcf,'ellipse',...
    ...
    'LineWidth',2,...
    'LineStyle','--');
print(gcf,'-depsc','-r400','syn_ves_rr_noise4.eps')
end
...
xlabel('Time (s)','Fontsize',20);
set(gca,'Linewidth',2,'Fontsize',20); 
    print(gcf,'-depsc','-r400','syn_obs_noise6.eps');
    figure;yc_wigbh(D3,h0,t,1);ylim([-0.9,20]);
    ylabel('Distance (deg)','Fontsize',20);
xlabel('Time (s)','Fontsize',20);
set(gca,'Linewidth',2,'Fontsize',20); 
    print(gcf,'-depsc','-r400','syn_pocs_noise6.eps');
    figure;yc_wigbh(D5,h0,t,1);ylim([-0.9,20]);
    ylabel('Distance (deg)','Fontsize',20);
xlabel('Time (s)','Fontsize',20);
set(gca,'Linewidth',2,'Fontsize',20); 
...
annotation(gcf,'ellipse',...
    ...
    'LineWidth',2,...
    'LineStyle','--');
print(gcf,'-depsc','-r400','syn_ves_rr_noise6.eps')
end
...
figure;plot(sigmas,snrs1,'ko-','linewidth',2);hold on;
plot(sigmas,snrs2,'bv-','linewidth',2);
plot(sigmas,snrs3,'r*-','linewidth',2);
...
xlabel('Noise level (Variance)','Fontsize',20);
